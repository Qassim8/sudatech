const AboutHero = () => {
  return (
    <section className="relative bg-linear-to-bl from-blue-950 to-blue-800 min-h-[70vh] overflow-hidden flex flex-col justify-center">
      ...
      <div className="container flex flex-col justify-start gap-8 z-20">
